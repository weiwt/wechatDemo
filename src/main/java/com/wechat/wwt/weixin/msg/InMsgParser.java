...
package com.wechat.wwt.weixin.msg;
...
import com.wechat.wwt.weixin.msg.in.event.ScanCodeInfo;
...
import com.wechat.wwt.weixin.utils.XmlHelper;
...
public class InMsgParser {
	...
	private static InMsg parseInEvent(XmlHelper xmlHelper, String toUserName, String fromUserName, Integer createTime, String msgType) {
		...
		if ("subscribe".equals(event) && StringUtil.notBlank(eventKey) && eventKey.startsWith("qrscene_")) {
		...
		if ("ShakearoundUserShake".equals(event)){
			...
			if (nodeList != null && nodeList.getLength() > 0) {
				...
				List<InShakearoundUserShakeEvent.AroundBeacon> aroundBeacons = new ArrayList<InShakearoundUserShakeEvent.AroundBeacon>();
