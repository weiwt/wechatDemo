package com.wechat.wwt.test.wxpay;

import com.wechat.wwt.weixin.wxpay.WXPay;
import com.wechat.wwt.weixin.wxpay.WXPayUtil;
import com.wechat.wwt.weixin.wxpay.impl.WXPayConfigImpl;
...
public class TestWXPay {
    ...
    public TestWXPay() throws Exception {
        ...
        wxpay = new WXPay(config,null,false,false);
        total_fee = "1";
